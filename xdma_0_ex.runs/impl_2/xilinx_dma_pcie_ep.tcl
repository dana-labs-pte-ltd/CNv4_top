...
set rc [catch {
  ...
  add_files -quiet /media/wanner/work/work/fpga_prj/CNv4_top_v1/xdma_0_ex.runs/synth_1/xilinx_dma_pcie_ep.dcp
...
set rc [catch {
  ...
  read_checkpoint -auto_incremental  -incremental /media/wanner/work/work/fpga_prj/CNv4_top_v1/xdma_0_ex.srcs/utils_1/imports/impl_2/xilinx_dma_pcie_ep_routed.dcp
